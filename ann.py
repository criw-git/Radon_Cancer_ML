...
def ann(X_train):
    #initializer = keras.initializers.lecun_uniform(seed=None) #0.8279
    #initializer = keras.initializers.glorot_uniform(seed=None) #0.8328
    #initializer = keras.initializers.he_normal(seed=None) #0.8317
