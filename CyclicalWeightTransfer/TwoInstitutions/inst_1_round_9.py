...
def cyc_model(X_train, X_test, y_train, y_test):
    model = load_model('Models/ann_inst_2_round_8')
...
cyc_model.save('Models/ann_inst_1_round_9')
###############################################################################
def ExtraTrees(X_train, X_test, y_train, y_test):
    model = load('Models/exttree_inst2_round_8.joblib')
...
dump(model, 'Models/exttree_inst1_round_9.joblib')