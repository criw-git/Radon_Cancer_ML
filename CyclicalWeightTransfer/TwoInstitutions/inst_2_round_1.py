...
def cyc_model(X_train, X_test, y_train, y_test):
    model = load_model('Models/ann_inst_1_round_1')
...
cyc_model.save('Models/ann_inst_2_round_1')
#######################################################################################
def ExtraTrees(X_train, X_test, y_train, y_test):
    model = load('Models/exttree_inst1_round_1.joblib')
...
dump(model, 'Models/exttree_inst2_round_1.joblib')