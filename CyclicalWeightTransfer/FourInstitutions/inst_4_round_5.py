...
def cyc_model(X_train, X_test, y_train, y_test):
    model = load_model('Models/ann_inst_3_round_5')
...
cyc_model.save('Models/ann_inst_4_round_5')
#######################################################################################
def ExtraTrees(X_train, X_test, y_train, y_test):
    model = load('Models/exttree_inst3_round_5.joblib')
...
dump(model, 'Models/exttree_inst4_round_5.joblib')