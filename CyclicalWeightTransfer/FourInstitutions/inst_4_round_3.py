...
def cyc_model(X_train, X_test, y_train, y_test):
    model = load_model('Models/ann_inst_3_round_3')
...
cyc_model.save('Models/ann_inst_4_round_3')
#######################################################################################
def ExtraTrees(X_train, X_test, y_train, y_test):
    model = load('Models/exttree_inst3_round_3.joblib')
...
dump(model, 'Models/exttree_inst4_round_3.joblib')